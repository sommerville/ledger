...
**Working files:**
- `index.html` — Mobile app (deploy name for `Ledger_v14_4.html`)
- `ledger-desktop.html` — Desktop dashboard
- `shared.js` — Shared state, encryption, storage, calculations (new as of v14.3)

**Version:** Ledger v14.4
**Line counts:** `index.html` ~14,740 · `ledger-desktop.html` ~10,356 · `shared.js` ~510
...
| `pf_er_goal` | String | Phase 1 retirement goal target (Ret Plan widget) |
...
`retirement.html` not yet in cache — add when uploaded to repo. `ret-plan.png` icon added to cache list.

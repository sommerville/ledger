...
|---|---|---|---|
| `index.html` | Sommerville Ledger | ✅ Done | Full mobile app — investments, income, expenses, debt, FIRE, retirement, coast |
...
*Files: index.html (~13,810 lines), ledger-desktop.html (~8,300 lines), shared.js (~510 lines), retirement.html (~1,015 lines)*

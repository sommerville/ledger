...
`income`, `investments`, `expenses`, `net-worth`, `fire`, `summary`, `calculator`, `compound-interest`, `budget`, `backtest`, `retirement`, `debt`, `home-value`, `ret-plan`, `data`, `log`, `settings`
